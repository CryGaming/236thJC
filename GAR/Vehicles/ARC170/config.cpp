...
class CfgVehicles
{
	...
	class LaserPilot;
	class Reargun;
	class 236th_arc_130: 3as_arc_170_base
	{
		scope=2;
		displayname="[236th] Arc-130 Heavy Gunship";
		crew = "236th_P1_Pilot";
		...
		laserScanner = 1;
		commanding = 3;
		hiddenselections[] = {"camo1","camo2","guns","glass"};
		hiddenselectionstextures[] = {"3as\3as_arc170\Data\units\212th_Main_Frame_CO.paa","3as\3as_arc170\Data\units\212th_Wings_Engines_CO.paa","3as\3as_arc170\Data\units\212th_Guns_CO.paa","a3\air_f_jets\plane_fighter_01\data\fighter_01_glass_01_ca.paa"};
		faction = "Fac236th";
		...
		class Turrets
		{
			class 236th_LaserPilot: LaserPilot
			{
				startEngine = 0;
				outGunnerMayFire = 0;
				commanding = -1;
				memorypointgunneroptics = "PilotCamera_pos_2";
			...
			class 236th_Reargun: Reargun
			{
				...
				weapons[] = {"3as_ARC_Light_Canon","CMFlareLauncher","cannon_105mm_VTOL_01","CMFlareLauncher","GMG_40mm"};
				magazines[] = {"3as_ARC_500Rnd_Light_Shells","240Rnd_CMFlare_Chaff_Magazine","100Rnd_105mm_HEAT_MP","96Rnd_40mm_G_belt","96Rnd_40mm_G_belt"};
				minElev = -30;
				maxturn = 270;
				minturn = 90;
				maxElev = 60;
